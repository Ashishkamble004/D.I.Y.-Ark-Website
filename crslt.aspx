<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="crslt.aspx.cs" Inherits="FinalProject.crslt" %>
...
<div class="w3-padding-48">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Every_Corsair] WHERE (([Package_contents] NOT LIKE '%' + @Package_contents + '%') AND ([Package_contents] NOT LIKE '%' + @Package_contents2 + '%'))">
        <SelectParameters>
            <asp:Parameter DefaultValue="Vengeance" Name="Package_contents" Type="String" />
            <asp:Parameter DefaultValue="Dominator" Name="Package_contents2" 
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:DataList ID="dl1" runat="server" DataKeyField="EveryCorsair_Id" 
