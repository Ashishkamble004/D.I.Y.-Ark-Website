<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cresult.aspx.cs" Inherits="FinalProject.cresult" %>
...
<div class="w3-padding-48">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Every_Corsair] WHERE ([Package_contents] LIKE '%' + @Package_contents + '%')">
        <SelectParameters>
            <asp:SessionParameter Name="Package_contents" SessionField="ctest" 
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:DataList ID="dl1" runat="server" DataKeyField="EveryCorsair_Id" 
        ...
        <ItemTemplate>
            ...
            <br />
            RAMs_Id:
            <asp:Label ID="RAMs_IdLabel" runat="server" 
                Text='<%# Eval("RAMs_Id") %>' />
            <br />
            Corsair_Id:
            ...
            <br />
            Density:
            <asp:Label ID="DensityLabel" runat="server" 
                Text='<%# Eval("Density") %>' />
            <br />
            Speed:
            ...
            <br />
            Voltage:
            <asp:Label ID="VoltageLabel" runat="server" 
                Text='<%# Eval("Voltage") %>' />
            <br />
